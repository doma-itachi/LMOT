...
function AlertDialogHeader(props: React.ComponentProps<'div'>): React.JSX.Element {
  const { className, ...rest } = props
...
function AlertDialogFooter(props: React.ComponentProps<'div'>): React.JSX.Element {
  const { className, ...rest } = props
